...
<div class="col-xs-12 col-lg-12">&nbsp;</div>
		...
		<div class="text-muted text-center">Everything Movies is a database of films in my personal collection.<p><i class="fa fa-copyright"></i>
 Greig Christie <?php echo date('Y'); ?> 
			<a href="http://twitter.com/treefell/"><i class="fa fa-twitter"></i></a></p>
			<p><a href="../">MUSIC</a> - <a href="../books/">BOOKS</a></p>
		</div>
</div>
</div>
</div>
